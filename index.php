       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">      
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
              ...
              <p>Online hotel reservations are a popular method for booking hotel rooms. Travelers can book
                  on a computer by using online security to protect their privacy and financial information
                  and by using several online travel agents to compare prices and facilities at different
                  hotels</p>
              <br>
              <p>Prior to the Internet, travelers could write, telephone the hotel directly, or use a travel
                  ...
                  allow reviews of the traveler to be recorded with the online travel agent.</p>
              <br>
              <p>Online hotel reservations are also helpful for making last minute travel arrangements.
                  Hotels may drop the price of a room if some rooms are still available. There are several
                  websites that specialize in searches for deals on rooms.</p>
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              Address : Audrian Otaba<br>
              Mail : otabanamiba@gmail.com <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Developed By</strong></h4><hr>
                <a href="#">@otabaadrian</a>
